...
import com.cx.reggiee.service.SetmealDishService;
...
public class SetmealController {
    ...
    public R<List<Setmeal>> list(Setmeal setmeal) {
        ...
        LambdaQueryWrapper<Setmeal> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.like(
            StringUtils.isNotEmpty(setmeal.getName()), Setmeal::getName, setmeal.getName());
        queryWrapper.eq(
            null != setmeal.getCategoryId(), Setmeal::getCategoryId, setmeal.getCategoryId());
